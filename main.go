...
func mainE(ctx context.Context) error {
	...
	daemonCommand.PersistentFlags().String(f.Service.Prometheus.Storage.Size, "50Gi", "Storage size for prometheus.")
	daemonCommand.PersistentFlags().String(f.Service.Prometheus.Retention.Duration, "2w", "Retention duration for prometheus.")
	daemonCommand.PersistentFlags().String(f.Service.Prometheus.Retention.Size, "45Gi", "Retention size for prometheus.")
