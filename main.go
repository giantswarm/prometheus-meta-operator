...
func mainE(ctx context.Context) error {
	...
	daemonCommand.PersistentFlags().Float64(f.Service.PrometheusAgent.ShardScaleDownPercentage, 0.20, "Prometheus agent shard scale down percentage to know when the to scale down the number of shards.")
