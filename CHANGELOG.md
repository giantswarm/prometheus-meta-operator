...
- Dynamically compute Prometheus request memory according to cluster size.
...
[Unreleased]: https://github.com/giantswarm/prometheus-meta-operator/compare/v4.39.0...HEAD
