...
- Pass over mimir enabled to managementcluster `remotewriteingressauth` and `remotewriteingress` resources.
...
[Unreleased]: https://github.com/giantswarm/prometheus-meta-operator/compare/v4.85.1...HEAD
[4.85.1]: https://github.com/giantswarm/prometheus-meta-operator/compare/v4.85.0...v4.85.1
